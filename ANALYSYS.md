...
| B7–B11, B12(filtro ricevute + euristica CF), N4 | ⬜ **APERTO/DOCUMENTATO** | B12 filtro cliente nella pagina Ricevute ed euristica anno CF: scelte deliberate registrate in `OPEN-QUESTIONS.md`. N4 (ricevute storiche minori con `assistito_cf` nullo): registrato in `DECISIONS.md`. Nota storica: A15a risolto in WP1; A15b/A15c decisioni (OPEN-QUESTIONS / DECISIONS D14). A7–A14 in WP2. B5/C2/C3/C6/B6/C9/N5 in WP4. **B1/B2/B3/B4 in WP3. D1–D12 in WP5. C7/C8/C10/C11/C12/C13(residui)/B12(parz.) in WP4b.** B7 (indirizzo tutore) registrato in OPEN-QUESTIONS come follow-up di B6. |
